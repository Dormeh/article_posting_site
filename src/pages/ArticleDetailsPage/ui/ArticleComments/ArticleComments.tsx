import { ForwardedRef, forwardRef, memo, Suspense, useCallback, useRef } from 'react';
...
const ArticleComments = forwardRef(
    (props: ArticleCommentsProps, ref: ForwardedRef<HTMLDivElement>) => {
            ...
            async (text) => {
                ...
                if (result.meta.requestStatus === 'fulfilled') {
                    if (ref && addCommentFormRef && typeof ref !== 'function') {
                        setTimeout(() => {
                            const cordDif =
                                (addCommentFormRef.current?.getBoundingClientRect().bottom || 0) -
